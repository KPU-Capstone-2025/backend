...
interface MonitoringServicePort {
    ...
    fun getLogs(
        companyId: Long, containerName: String?, severity: String?,
        keyword: String?, limit: Int, hostName: String? = null
    ): List<LogEntry>
    ...
    fun queryRangePublic(query: String, prometheusUrl: String, start: Long, end: Long, step: Int): List<Pair<Long, Double>>

    fun querySingleValuePublic(query: String, prometheusUrl: String): Double?
}
